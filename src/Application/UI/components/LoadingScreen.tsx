        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: 01/13/2024</p>
                            <p>HYDRA OS (C)2024 Omnicron Hydra Inc.,</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>HYDRA OS 2022-2024 Special UC131S</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>HYDRA OS Showcase(tm) XX 113</p>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'Omnicron Hydra Portfolio Showcase'
                                </b>{' '}
                                V1.0
                            </p>
                        )}
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Hydra Omnicron Portfolio Showcase 2024</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
                                ...
                                <p style={styles.warning}>
                                    a desktop or laptop computer, as mobile will require high GPU rendering.
                                </p>
                            </b>
                            <br />
                        </>
                    ...
                    <div style={styles.startPopup}>
                        ...
                        <p>
                            ...
                            <a
                                style={styles.link}
                                href={
                                    'https://github.com/Omnicron-Hydra/os-portfolio'
                                }
                            >
                                bug in firefox
                            </a>
